public class Connect4Control
{
    ...
    {
        player = 1;
        cont = new int[7][8];//adds one extra row from 6 to 7 as col 7 was not being accessed.
    ...
    public void win(){
        //85 different possible winning scenarios and we check for every single one
        //got most of the logic for the game from github
        //=========================================================================================
    ...
    //check columns for spaces and also check if we need to change the color of the player.
